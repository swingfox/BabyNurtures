...
public class Choose_Child_Task extends AppCompatActivity {

    private static final String TAG =Choose_Child_Task.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose__child__task);
        ...
        lv = (ListView) findViewById(R.id.list_of_tasks);
        customListAdapter = new CustomListAdapter(Choose_Child_Task.this, babylist);
    //    customListAdapter = new CustomListAdapter(Choose_Child_Task.this, Tracker.array);
       // ListAdapter taskAdapter = new ArrayAdapter<Baby>(this, android.R.layout.activity_choose__child__task,babylist);
        ...
        final String created_by = settings.getString("keyWhoCreated", "");
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Baby index = (Baby) babylist.get(position);

                String fullname = index.getBabyName();
                String type = settings.getString("keyType","");
                if(type.equals("1")) {

                    Intent intent = new Intent(Choose_Child_Task.this, maidlist.class);
                ...
                if(type.equals("0")){
                    Intent intent = new Intent(Choose_Child_Task.this, maidlist.class);
                    //String created_bys = settings.getString("keyEmail", "");
                    intent.putExtra("keyName",created_by);
                    intent.putExtra("keyFullname", fullname);
                    intent.putExtra("keyGender", gender);
                    Log.d(TAG, " created by " + created_by + " created for" +fullname+ " key: "+type);
                    startActivity(intent);
                }
            }
        });

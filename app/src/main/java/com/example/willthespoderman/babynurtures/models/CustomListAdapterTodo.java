...
public class CustomListAdapterTodo extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<todo> tutors;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();

    public CustomListAdapterTodo(Activity activity, List<todo> tutors) {
